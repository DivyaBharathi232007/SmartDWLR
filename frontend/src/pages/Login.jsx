...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-x-hidden overflow-y-auto bg-navy-900 px-6 py-8 lg:justify-between lg:px-0 lg:py-0">
